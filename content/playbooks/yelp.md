...
related: [playbook.speed-to-lead, script.csm.marketplace-outreach, sop.csm.lead-source, sop.csm.tools, script.csm.review-request]
section: channels
order: 7
...
Same as Angi and Thumbtack. Yelp messages typically generate an email notification, which usually makes an integration viable, but this needs confirming. Until then, **work these manually as they land**.
