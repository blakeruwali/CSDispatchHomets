...
export const TABS: TabDef[] = [
  ...
  { id: "checklist", path: "/checklist", label: "Live Scoring" },
  { id: "rubric-seed", path: "/admin/seed", label: "Rubric Seed" },
...
/**
 * Every SOP book, read-only in the sense that opening one writes nothing.
 * Excludes Live Scoring, which creates QA session records about people, and
 * both admin tabs.
 */
...
export const ROLE_TABS: Record<string, string[]> = {
  ...
  dispatch: ["dispatch", "csm", "membership", "checklist"],
  ...
  // "Read-all, no admin" made concrete: every book, but not Live Scoring —
  // that writes QA records about named staff — and neither admin tab.
  hr: ALL_BOOKS,
